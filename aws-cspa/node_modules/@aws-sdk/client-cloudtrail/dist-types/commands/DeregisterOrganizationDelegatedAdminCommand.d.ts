...
import type { DeregisterOrganizationDelegatedAdminRequest, DeregisterOrganizationDelegatedAdminResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeregisterOrganizationDelegatedAdminCommand_base: {
    new (input: DeregisterOrganizationDelegatedAdminCommandInput): import("@smithy/core/client").CommandImpl<DeregisterOrganizationDelegatedAdminCommandInput, DeregisterOrganizationDelegatedAdminCommandOutput, CloudTrailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeregisterOrganizationDelegatedAdminCommandInput): import("@smithy/core/client").CommandImpl<DeregisterOrganizationDelegatedAdminCommandInput, DeregisterOrganizationDelegatedAdminCommandOutput, CloudTrailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
