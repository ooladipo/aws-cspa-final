...
import type { CreateEventDataStoreRequest, CreateEventDataStoreResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateEventDataStoreCommand_base: {
    new (input: CreateEventDataStoreCommandInput): import("@smithy/core/client").CommandImpl<CreateEventDataStoreCommandInput, CreateEventDataStoreCommandOutput, CloudTrailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateEventDataStoreCommandInput): import("@smithy/core/client").CommandImpl<CreateEventDataStoreCommandInput, CreateEventDataStoreCommandOutput, CloudTrailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
